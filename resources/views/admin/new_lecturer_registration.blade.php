...
<div style="max-width: 800px; margin: 0 auto;">
    ...
    <div style="background: var(--white); padding: 30px; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.06); margin-bottom: 20px;">
        ...
        <p style="color: var(--muted); font-size: 14px; margin-bottom: 24px;">Add a new lecturer to the system. Login credentials will be sent to their email.</p>
        ...
        <form method="POST" action="{{ route('admin.store_user') }}">
            ...
            <div style="margin-bottom: 24px;">
                ...
                <small style="color: var(--muted); margin-top: 4px; display: block;">Login credentials will be sent to the lecturer's email address.</small>
            </div>
