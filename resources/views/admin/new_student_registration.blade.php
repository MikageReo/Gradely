...
<div style="max-width: 800px;">
    ...
    <div style="background: var(--white); padding: 30px; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.06);">
        <h2 style="font-size: 20px; color: #222; margin-bottom: 8px;">📥 Bulk Register Students (Excel)</h2>
        <p style="color: var(--muted); font-size: 14px; margin-bottom: 24px;">Upload an Excel file (.xlsx) to register multiple students at once</p>
        ...
        <form method="POST" action="{{ route('admin.bulk_register') }}" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <small style="color: var(--muted); margin-top: 8px; display: block;">
                    ...
                    <code>John Doe | john@email.com | student</code>
                </small>
            </div>
