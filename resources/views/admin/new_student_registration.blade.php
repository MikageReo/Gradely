...
<div style="max-width: 800px;">
    <div style="background: var(--white); padding: 30px; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.06); margin-bottom: 20px;">
        ...
        <p style="color: var(--muted); font-size: 14px; margin-bottom: 24px;">Add a new student to the system</p>
    ...
    <div style="background: var(--white); padding: 30px; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.06);">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
            <h2 style="font-size: 20px; color: #222; margin: 0;">📥 Bulk Register Students (CSV)</h2>
            <a href="{{ route('admin.download_template', ['role' => 'student']) }}" 
               target="_blank"
        ...
        <p style="color: var(--muted); font-size: 14px; margin-bottom: 24px;">Upload a CSV file to register multiple students at once</p>
        ...
        <form method="POST" action="{{ route('admin.bulk_register') }}" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <small style="color: var(--muted); margin-top: 4px; display: block;">
                    <strong>CSV Format:</strong> One student per line. Format: <code>Name,Email</code> or just <code>Email</code>
                </small>
            </div>
