...
@section('title', 'Edit Course - GRADELY')
...
@section('content')
<div class="header">
    <h1 style="font-size: 24px; color: #222; margin-bottom: 8px;">Edit Course</h1>
    <p style="color: var(--muted); font-size: 14px;">Update course information.</p>
</div>
